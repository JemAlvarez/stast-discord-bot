const dares = [
    ...
    "Wear you underwear over your pants for the rest of the game.",
    ...
    "Single the Star Spangled Banner in a British accent.",
    "Take a picture of a tampon and post it on Instagram.",
    "Call and random number, and when someone picks up, immediately start singing the National Anthem.",
    "Call Target and ask them if they deliver popcorn.",
    "Call Macdonald's and ask if they sell Whoppers.",
    "Call pizza shop and ask if you can return a pizza.",
    ...
    "Let the person to your left do you makeup.",
    "Call a guy of the group's choosing and tell him he's the ugliest person you've ever met.",
    "Dip you finger in the toilet and then kiss that finger.",
    "Lick a doorknob.",
